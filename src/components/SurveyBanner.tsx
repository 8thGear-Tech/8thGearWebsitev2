  ...
  return (
    <>
      {showModal && (
        ...
        >
          <div
            ...
            className="relative w-full max-w-[520px] rounded-xl border-2 border-purple bg-[#2c2c2c] px-9 pb-8 pt-10 shadow-[0_20px_60px_rgba(0,0,0,0.4)] [animation:slide-up_0.35s_ease]"
          >
            <button
              type="button"
              onClick={handleModalClose}
              aria-label="Close"
              className="absolute -right-3.5 -top-3.5 z-10 flex h-[30px] w-[30px] items-center justify-center rounded-full border-2 border-white bg-purple text-white transition-colors hover:bg-white/20"
            >
              <CloseIcon />
            </button>
      ...
      {showBanner && (
        ...
        >
          <div className="relative mx-auto flex max-w-[1400px] flex-col items-stretch gap-3 px-3 py-2.5 sm:flex-row sm:items-center sm:justify-between sm:gap-3 sm:px-5 sm:pr-5">
            <div className="min-w-0 flex-1 sm:flex sm:flex-col sm:gap-1">
              ...
              <p className="m-0 text-[11px] leading-[1.4] text-[#e0e0e0] sm:truncate sm:whitespace-nowrap sm:text-xs">
                ...
                <span className="mx-[3px] font-semibold text-[#c3ca18]">actually move the needle</span> for your

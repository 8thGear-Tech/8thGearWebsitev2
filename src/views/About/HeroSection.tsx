...
export function HeroSection() {
  return (
    <div className="relative flex min-h-[60vh] w-full items-center justify-center overflow-hidden bg-[#f9fafb]">
      {/* Orbs */}
      <div className="pointer-events-none absolute -right-20 -top-45 h-75 w-75 rounded-full bg-purple opacity-45 blur-[90px] md:h-125 md:w-125" />
      <div className="pointer-events-none absolute bottom-15 right-50 h-65 w-65 rounded-full bg-amber-400 opacity-20 blur-[90px]" />
      ...
      <div className="relative z-[1] mx-auto flex w-full max-w-300 flex-col items-center justify-between gap-12 px-6 py-20 text-center md:flex-row md:px-8 md:py-24 md:text-left">
        {/* Left: text */}
        <div className="max-w-145 flex-1">
          ...
          <p className="mx-auto mb-8 max-w-115 text-base leading-[1.75] text-[#0f2020]/60 md:mx-0">
        ...
        <div className="relative hidden h-85 w-75 shrink-0 md:block">
          ...
          <div className="absolute flex h-75 w-65 flex-col items-center justify-center gap-3 rounded-[20px] border border-black/[0.06] bg-white p-8 shadow-brand">
            <div className="flex flex-col items-center py-3 text-center">
              ...
              <span className="mt-1 text-xs font-medium tracking-widest text-[#0f2020]/50">MSMEs Supported</span>
            </div>
            <div className="h-px w-10 bg-black/[0.08]" />
            <div className="flex flex-col items-center py-3 text-center">
              <span className="text-[2rem] font-extrabold leading-none text-[#0f1f20]">7+</span>
              <span className="mt-1 text-xs font-medium tracking-widest text-[#0f2020]/50">Years of Impact</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute inset-x-0 bottom-0 h-0.75 bg-[linear-gradient(90deg,#1a988f,#c0258f,#f4a01c,#7b2d8b,#1a988f)] bg-[length:200%_100%] [animation:gradient-slide_4s_linear_infinite]" />
    </div>
  );
}

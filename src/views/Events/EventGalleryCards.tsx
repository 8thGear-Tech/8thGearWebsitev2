...
export function GalleryImageGrid({ images }: { images: GalleryImage[] }) {
  return (
    <div className="mx-auto grid max-w-[1400px] grid-cols-1 gap-6 px-4 py-8 sm:grid-cols-2 lg:grid-cols-3 lg:px-12">
      {images.map((image) => (
...
export function GalleryVideoGrid({ videos }: { videos: GalleryVideo[] }) {
  return (
    <div className="mx-auto grid max-w-[1400px] grid-cols-1 gap-6 px-4 pb-12 sm:grid-cols-2 lg:grid-cols-3 lg:px-12">
      {videos.map((video) => (

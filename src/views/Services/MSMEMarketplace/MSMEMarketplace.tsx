...
const CHIP =
  "mb-3.5 inline-flex items-center rounded-full border border-teal/25 bg-teal/[0.07] px-3.5 py-1.25 font-body text-[11px] font-bold uppercase tracking-widest text-teal";
const DIVIDER = "mx-auto mb-4.5 h-0.75 w-11 rounded-full bg-teal";
const DIVIDER_LEFT = "mb-4.5 h-0.75 w-11 rounded-full bg-teal";
...
export function MSMEMarketplace() {
  return (
    <div>
          ...
          <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2">
            ...
            <div className="text-center">
              <Image
                src={b2bImage}
                alt="B2B Solutions"
                className="mb-10 w-full max-w-125 rotate-[-2deg] rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.3)]"
              />
            </div>
          </div>
        </div>
      ...
      <section className="relative bg-grey-bg pb-20 pt-25">
        ...
        <div className="relative z-[1] mx-auto max-w-350 px-4">
          <div className="mb-12 text-center">
            ...
            <p className={`${SECTION_COPY} mx-auto max-w-175`}>
              Join hundreds of growing businesses who trust our curated marketplace for reliable, scalable B2B
              solutions that drive real results.
            </p>
          </div>

          <div className="mx-auto grid max-w-250 grid-cols-1 gap-7 md:grid-cols-2">
            {FEATURES.map((f) => {
              const purple = f.color === "purple";
              return (
                <div
                  key={f.title}
                  className={`group relative flex min-h-61.25 cursor-pointer flex-col items-start overflow-hidden rounded-xl border-2 border-grey-border bg-white px-7 py-8 shadow-brand transition-[transform,box-shadow,border-color] duration-300 ease-out hover:-translate-y-2 hover:shadow-brand-lg ${
                    purple ? "hover:border-purple" : "hover:border-teal"
                  }`}
                >
                  <div
                    className={`mb-6 flex h-13.5 w-13.5 items-center justify-center rounded-2xl transition-colors duration-300 ${
                      purple
      ...
      <section className="relative bg-purple/20 py-23">
        <div className="mx-auto max-w-350 px-4">
          <div className="mb-12 text-center">
            ...
            <p className={`${SECTION_COPY} mx-auto max-w-150`}>
              Handpicked software and tools designed for scalability and reliability.
            </p>
          </div>

          <div className="mx-auto grid max-w-295 grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-6 lg:grid-cols-[repeat(auto-fit,minmax(280px,1fr))]">
            {SOLUTIONS.map((sol) => {
              ...
              const dotClass = `mt-0.75 h-3 w-3 flex-shrink-0 rounded-full ${
              ...
              return (
                ...
                >
                  ...
                  <div className={bodyClass}>
                    ...
                    <p className="mb-4.5 flex-grow font-body text-[0.95rem] font-light text-white/[0.78]">{sol.desc}</p>
          ...
          <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2">
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-xl border-[1.5px] border-teal bg-transparent px-5 py-2.25 font-body text-[13px] font-semibold text-teal no-underline transition-colors duration-200 hover:bg-teal hover:text-white focus-visible:bg-teal focus-visible:text-white"
              >
      ...
      <section className="relative bg-grey-bg py-18">
        <div className="mx-auto max-w-350 px-4 text-center">
          ...
          <p className={`${SECTION_COPY} mx-auto mb-10 max-w-125`}>
...
function PartnersSection() {
  return (
    <div className="mx-auto mt-12 max-w-350 px-4 pt-12">
      <div className="relative flex h-125 items-center justify-center overflow-hidden rounded-2xl text-center text-white">
